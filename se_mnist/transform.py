...
# This implementation can be considered as a generalized version at https://github.com/kevinzakka/spatial-transformer-network/blob/master/stn/transformer.py
